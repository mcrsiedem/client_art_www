...
function PrzerwaBTN() {
  ...
  return (
    <div className={style.przerwa_container}>
      ...
      <TimeSelect
        ...
        initMinuty={initMinuty}
        setInitMintuty={setInitMintuty}
      />
    </div>
  );
  ...
  function handleDrop() {
    if (
      sessionStorage.getItem("typ_drag") == "grupa_proces" &&
      sessionStorage.getItem("typ_grupy") == 1
    ) {
      updateDeletePrzerwaOprawa(
        sessionStorage.getItem("id_grupa_proces_drag"),
...
const TimeSelect = ({
  ...
  if (show)
    return (
      <div className={style.time_selec_container}>
        <input
          value={initTime}
