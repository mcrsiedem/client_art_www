...
export default function  CellBtn({ row }) {
  ...
  if( row.technologia_stan == 1 )  return <BtnFileYellow row={row}/>
...
function BtnFileYellow({
  ...
  const setShowProcesy = techContext.setShowProcesy;
    ...
    return (
       ...
       <button style={{color: '#db850d',border:'none',background:'transparent'}}
            ...
            alt="Procesy"
          >
<FileText size={16} style={{color: '#db850d',border:'none'}} />
