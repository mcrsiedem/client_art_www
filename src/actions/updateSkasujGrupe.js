...
export function updateSkasujGrupe(global_id_grupa,fechparametryTechnologii,zamowienie_id,technologia_id) {

// id = procesor id

  axios.get(IP + "skasujGrupe/"+global_id_grupa+"/"+ sessionStorage.getItem("token"))
    .then((res) => {
