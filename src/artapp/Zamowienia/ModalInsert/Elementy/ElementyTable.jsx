...
export default function ElementyTable({elementy,setElementy,handleChangeCardElementy,selected_papier,setSelected_papier,fragmenty,setFragmenty,info,setInfo,listaWykonczenia,selected_wykonczenie,setSelected_wykonczenie,listaGramatur,listaPapierow,setListaGramatur,setListaWykonczen,isEdit, setIsEdit,listaUszlachetnien, setListaUszlachetnien,procesyElementow,setProcesyElementow,listaDostepnychProcesow}) {
