                ...
                <div className={style.main}>
                        <div className={style.header}>
                                ...
                                <div className={style.container_btn} >
                                                                        ...
                                                                        <div className={style.kafle} onClick={() => { navigate("/ProcesyMini") }} ><p className={style.znak }>  </p><img className={style.icon } src={iconProcesy} alt="Zamówienia" /><p className={style.menu_txt}>PROCESY</p> </div> 
