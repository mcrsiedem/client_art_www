                ...
                <div className={style.main}>
                        <div className={style.header}>
                                ...
                                <div className={style.container_btn} >
                                                                        ...
                                                                        <div className={style.kafle}  onClick={() => { navigate("/Zamowienia") } }><p className={style.znak }>  </p><img className={style.icon } src={iconTechnolgie} alt="Faktury" /><p className={style.menu_txt}>FAKTURY</p></div>
