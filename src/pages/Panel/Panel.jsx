      ...
      setIsOpen(false)
            ...
            setIsOpen(false)
                                ...
                                <div className={style.container_btn} >
                                                                        ...
                                                                        <div className={style.kafle} onClick={() => { navigate("/Oddania") }}><p className={style.znak }>  </p><img className={style.icon } src={iconCTP} alt="CTP" /> <p className={style.menu_txt}>CTP</p></div>
