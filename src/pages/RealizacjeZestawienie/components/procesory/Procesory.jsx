...
import style from "./Procesory.module.css";
...
function Proceosory({dataOd, dataDo}) {
...
if(showTabsRealizacje.maszyny){
    ...
    <div className={style.container}>
      ...
      <TableRealizacjeZestawienie dataDo={dataDo} dataOd={dataOd} open2={open2} setRow={setRow}  header={false} />
      <Footer dodaj_clikHandler={dodaj_clikHandler} kto={kto}  />
    </div>
  );
}

}
export default Proceosory;