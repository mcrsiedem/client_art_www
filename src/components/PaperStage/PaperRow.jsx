...
export default function PaperRow({row,inputElement,setSelectTable,setSelectRow}) {
      ...
      return (
        ...
        >
          ...
          <Bulk row={row} />
          <Powleczenie row={row} />
          {/* <td className={ style.nazwa }>{listaPapierowPowleczenie.map(x=> x.id == row.powleczenie_id).poleczenie}</td> */}
          <Info row={row} />
        </tr>
      );
...
function Powleczenie({ row}) {
  const appcontext = useContext(AppContext);
  const listaPapierowPowleczenie = appcontext.listaPapierowPowleczenie;
  return <td>{listaPapierowPowleczenie?.filter(x => x.id == row.powleczenie_id)[0].powleczenie}</td>;
}

function Powleczenie2({ row }) {
  const appcontext = useContext(AppContext);
  const listaPapierowGrupa = appcontext.listaPapierowGrupa;
  const listaPapierowWyszukiwarka = appcontext.listaPapierowWyszukiwarka;
  const setListaPapierowWyszukiwarka = appcontext.setListaPapierowWyszukiwarka;
