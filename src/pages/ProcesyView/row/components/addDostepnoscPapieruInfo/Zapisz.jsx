...
import { addDostepnoscPapieru6 } from "./addDostepnoscPapieru";
export default function Zapisz({setShow,wykonanie,value,grup}) {
    ...
    return (
      <button
        className={style.btn}
        onClick={() => {
          addDostepnoscPapieru(setShow,wykonanie,value,wykonania,setWykonania,realizacje,setRealizacje,grupyWykonanAll,setGrupWykonanAll,grup)
          setShow(false)
