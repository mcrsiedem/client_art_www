      ...
      setIsOpen(false)
            ...
            setIsOpen(false)
                                ...
                                <div className={style.container_btn} >
                                                                        ...
                                                                        <div className={style.kafle} onClick={() => { navigate("/kalendarz") }}><p className={style.znak }>  </p><img className={style.icon } src={iconKalendarz} alt="Ustawienia" /><p className={style.menu_txt}>KALENDARZ</p><img className={style.iconLock } src={iconLock} alt="Zamówienia" /></div>
