...
const [showWyszukiwarka, setShowWyszukiwarka] = useState(false);
    ...
    const [dataSpedycji, setDataSpedycji] = useState(null);
    const [dataPrzyjecia, setDataPrzyjecia] = useState(null);
...
const updatePagination = (updates) => {
  ...
  return (
   ...
   _widokZamowien,handlePageChange,
      ...
      arkusz_wysokosc,setArkusz_wysokosc,arkusz_szerokosc, setArkusz_szerokosc,dataSpedycji, setDataSpedycji,dataPrzyjecia, setDataPrzyjecia
